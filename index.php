...
<body>
	<form style="background-color: darkblue; height: 80px; padding-top: 10px;" action="login_check.php" method="POST">
		<div style="padding: 10px; width: 450px; display: inline-flex; ">
			<b style="font-family:Block; font-size: 27px; color: #FFFF00; margin-left: 75px;">College Enrollment System</b>
		</div>
	...
	<footer style="background-color: gray; height: 65px;">
		<div style="padding-top: 10px; padding-left: 25px;"></div>
		<div style="padding-bottom: 15px; padding-left: 25px;"></div>
	</footer>
